...
export function coverRankTable(markdown, catalog) {
  ...
  if (section.includes("Haiku") && section.includes("effortなし")) {
  ...
  if (section.includes("ChatGPT")) {
    const chat = catalog.candidates.find((candidate) => candidate.selectable && candidate.family === "chatgpt" && candidate.harness === "gpt-connector" && candidate.effort === null);
    if (!chat) missing.push("ChatGPT");
  }
