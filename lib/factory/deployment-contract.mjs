...
export const CURRENT_WIRE_PRODUCT_IDS = Object.freeze([
  ...MANAGED_PRODUCT_IDS.slice(0, 8), 'servermanager', 'claude-code', 'codex-cli', 'grok-build', 'aishell', 'peertable', 'unai', 'jev-ultrafast', 'agent-desktop',
]);
...
const BASE_REQUIRED = Object.freeze(['caveat', 'throughline', 'spotter', 'lattice', 'markitdown', 'gpt-connector', 'aiterm-mcp', 'codex-sidecar', 'peertable', 'unai', 'jev-ultrafast']);
