...
export const FACTORY_RUNNERS = Object.freeze([
  Object.freeze({ name: 'factory-macos-m5', label: 'macos-native' }),
  Object.freeze({ name: 'factory-linux-main', label: 'linux-server' }),
  Object.freeze({ name: 'factory-linux-rabbit', label: 'linux-workstation' }),
  Object.freeze({ name: 'factory-windows-fox', label: 'windows-native' }),
]);
