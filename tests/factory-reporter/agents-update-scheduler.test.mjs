...
test('delivery receiptは未配送・古いreceipt・token不一致を拒否し、同一batchの受理だけ通す', async () => {
  ...
  const token = '11111111-1111-4111-8111-111111111111'; const report = { schema_version: '9.0', report_id: 'new-report' };
...
test('scheduled runnerは実行ごとのbatch tokenと今回のv9 delivery receiptを必須にする', async () => {
