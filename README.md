...
| 面 | Cursor所有 | やらないこと |
|---|---|---|
| 憲法 | `~/.cursor/rules/factory.mdc`（Desktop Agent へは `cursor-constitution-hook` が同一本文を sessionStart で配達） | `~/.cursor/AGENTS.md`。User Rules UIへの手貼り |
